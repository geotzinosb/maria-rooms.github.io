...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initLanguageSwitcher() {
        ...
        if (pathSegments.length > 0 && ['en', 'el', 'de', 'bg'].includes(pathSegments[0])) {
        ...
        // Add event listeners for desktop language switcher
        const languageToggle = document.getElementById('language-toggle');
        const languageDropdown = document.getElementById('language-dropdown');
        
        if (languageToggle && languageDropdown) {
            console.log('Language toggle and dropdown found, adding event listeners...');
            ...
            console.log('Language toggle or dropdown not found');
        }
        
        // Add event listeners for mobile language switcher
        const mobileLanguageOptions = document.querySelectorAll('.mobile-language-option');
    ...
    function showLanguageDropdown() {
        ...
        if (dropdown) {
            console.log('Showing language dropdown');
    ...
    function hideLanguageDropdown() {
        ...
        if (dropdown) {
            console.log('Hiding language dropdown');
